...
export const translations = {
    en: {
        ...
        settings: {
            ...
            interface: { title: "Interface", desc: "Input and Navigation controls.", scroll_mode_title: "Scroll Mode", scroll_mode_desc: "Toggle between cinematic snap scroll or native free scroll.", mode_cinematic: "Cinematic", mode_free: "Free Scroll" },
    ...
    "pt-BR": {
        ...
        settings: {
            ...
            interface: { title: "Interface", desc: "Controles de entrada e navegação.", scroll_mode_title: "Modo de Rolagem", scroll_mode_desc: "Alterne entre rolagem cinemática ou rolagem livre nativa.", mode_cinematic: "Cinemático", mode_free: "Livre" },
